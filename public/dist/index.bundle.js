...
var _LazyImage = _interopRequireDefault(__webpack_require__(/*! ../LazyImage/LazyImage.svelte */ "./assets/LazyImage/LazyImage.svelte"));

var _WebWorkers = _interopRequireDefault(__webpack_require__(/*! ../WebWorkers/WebWorkers.svelte */ "./assets/WebWorkers/WebWorkers.svelte"));

var _ImmutableComponent = _interopRequireDefault(__webpack_require__(/*! ../ImmutableComponent/ImmutableComponent.svelte */ "./assets/ImmutableComponent/ImmutableComponent.svelte"));
...
function create_main_fragment(component, ctx) {
  ...
  var lazyimage = new _LazyImage.default({
    root: component.root
  });
  var webworkers = new _WebWorkers.default({
    root: component.root
  });
  var immutablecomponent = new _ImmutableComponent.default({
    root: component.root
  });
  return {
    c: function c() {
      ...
      webworkers._fragment.c();

      text_3 = (0, _shared.createText)("\r\n");

      immutablecomponent._fragment.c();
    },
    m: function m(target, anchor) {
      (0, _shared.insertNode)(h1, target, anchor);
      (0, _shared.appendNode)(text, h1);
      (0, _shared.insertNode)(text_1, target, anchor);

      lazyimage._mount(target, anchor);

      (0, _shared.insertNode)(text_2, target, anchor);

      webworkers._mount(target, anchor);

      (0, _shared.insertNode)(text_3, target, anchor);

      immutablecomponent._mount(target, anchor);
    },
    ...
    u: function u() {
      ...
      immutablecomponent._unmount();
    },
    d: function d() {
      lazyimage.destroy(false);
      webworkers.destroy(false);
      immutablecomponent.destroy(false);
    }
  };
}
...
/***/ "./assets/ImmutableComponent/ImmutableComponent.svelte":
/*!*************************************************************!*\
  !*** ./assets/ImmutableComponent/ImmutableComponent.svelte ***!
  \*************************************************************/
/*! no static exports found */
...
/* assets\ImmutableComponent\ImmutableComponent.svelte generated by Svelte v2.4.1 */
function data() {
  return {
    headline: 'wellcome to my Immutable component'
  };
}
...
function oncreate() {
  var myStudent = (0, _immutable.Map)({
    student: {
      name: 'Esmeraldi',
      age: 26,
      parent: {
  ...
  var student = myStudent.get('student');
  console.log(myStudent.get('student'));
  var student2 = student; // student2 = student.parent.name = 'he is not my dad';

  console.log(myStudent.get('student'));
  var student3 = student2; // student.parent.name = 'he is not my dad because I changed twice';

  console.log(myStudent.get('student'));
  student.name = 'I tried to change my name';
  console.log(myStudent.get('student'));
}
...
function ImmutableComponent(options) {
  var _this = this;
  ...
  this.root._oncreate.push(function () {
    ...
    _this.fire("update", {
      changed: (0, _shared.assignTrue)({}, _this._state),
...
(0, _shared.assign)(ImmutableComponent.prototype, _shared.proto);
(0, _shared.assign)(ImmutableComponent.prototype, methods);
var _default = ImmutableComponent;
exports.default = _default;

/***/ }),

/***/ "./assets/LazyImage/LazyImage.svelte":
/*!*******************************************!*\
  !*** ./assets/LazyImage/LazyImage.svelte ***!
  \*******************************************/
/*! no static exports found */
...
/* assets\LazyImage\LazyImage.svelte generated by Svelte v2.4.1 */
function data() {
  return {
    placeholderSource: '',
    imageToLazyLoad: '',
...
function create_main_fragment(component, ctx) {
  ...
  return {
    c: function c() {
      ...
      img.className = "lazy";
      img.src = ctx.placeholderSource;
      img.dataset.src = ctx.imageToLazyLoad;
      img.alt = ctx.altText;
    },
    m: function m(target, anchor) {
      (0, _shared.insertNode)(img, target, anchor);
    },
    p: function p(changed, ctx) {
      if (changed.placeholderSource) {
        img.src = ctx.placeholderSource;
      }

      if (changed.imageToLazyLoad) {
        img.dataset.src = ctx.imageToLazyLoad;
      }
...
(0, _shared.assign)(LazyImage.prototype, _shared.proto);
var _default = LazyImage;
exports.default = _default;

/***/ }),

/***/ "./assets/WebWorkers/WebWorkers.svelte":
/*!*********************************************!*\
  !*** ./assets/WebWorkers/WebWorkers.svelte ***!
  \*********************************************/
/*! no static exports found */
...
/* assets\WebWorkers\WebWorkers.svelte generated by Svelte v2.4.1 */
function data() {
  return {
    sample: 'sample data from web workers'
  };
}
...
function oncreate() {
  var puntori = new Worker('/workers/puntori.js');
  puntori.postMessage({
    job: 'calculate'
  });
  puntori.addEventListener('message', function (event) {
...
function create_main_fragment(component, ctx) {
  ...
  return {
    c: function c() {
      ...
      h1 = (0, _shared.createElement)("h1");
      text = (0, _shared.createText)(ctx.sample);
      section.className = "play-web-workers";
    },
    m: function m(target, anchor) {
      (0, _shared.insertNode)(section, target, anchor);
      (0, _shared.appendNode)(h1, section);
      (0, _shared.appendNode)(text, h1);
    },
    p: function p(changed, ctx) {
      if (changed.sample) {
        text.data = ctx.sample;
      }
    },
    u: function u() {
      (0, _shared.detachNode)(section);
    },
    d: _shared.noop
  };
}
...
(0, _shared.assign)(WebWorkers.prototype, _shared.proto);
var _default = WebWorkers;
exports.default = _default;
